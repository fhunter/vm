	...
	switch (OP(word)) {
		...
		case OP_ALU: {
			...
			switch (ALU_OP(word) >> 8) {
				...
				case ALU_OP_N: res = n; break;
				case ALU_OP_PLUS: res = t + n; break;
				case ALU_OP_AND: res = t & n; break;
				case ALU_OP_OR: res = t | n; break;
				case ALU_OP_XOR: res = t ^ n; break;
				case ALU_OP_NEG: res = ~t; break;
				case ALU_OP_EQ: res = (t == n); break;
				case ALU_OP_LESS: res = (n < t); break;
				case ALU_OP_RSHIFT: res = (n >> t); break;
				case ALU_OP_DEC: res = t-1; break;
				case ALU_OP_R: res = r; break;
				case ALU_OP_MEM: res = ivm_mem_get(t); break;
				case ALU_OP_LSHIFT: res = (n << t); break;
				case ALU_OP_DEPTH: res = ivm_dp+1; break;
				case ALU_OP_ULESS: res = (n < t); break;
			}

			switch (ALU_DS(word)) {
				case (1 << 0): ivm_dp++; break;
				case (2 << 0): ivm_dp--; break;
			}

			switch (ALU_RS(word)) {
				case (1 << 2): ivm_rp++; break;
				case (2 << 2): ivm_rp--; break;
			}
